...
SECRET_KEY = '-0(n7lg^r=b!u&$y6@rlcbw(64w22_zxc^i2ruq6oi#2xb*wav'
...
LOGIN_REDIRECT_URL = reverse_lazy('dashboard')  #which URL to redirect after login if the contrib.auth.views.login view gets no next parameter
